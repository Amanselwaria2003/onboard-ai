...
- [x] 2. Implement SQLAlchemy models
  ...
  - [x] 2.1 Write unit test for models importability
    - Test `models.py` imports without error
    - Assert `Employee` and `Task` are `db.Model` subclasses
    - _Requirements: 5.1, 5.2, 5.3_

- [x] 3. Implement Flask application factory
  ...
  - [x] 3.3 Write property test for blueprint registration
...
- [x] 4. Scaffold route blueprint files
  ...
  - [x] 4.1 Write unit tests for route modules
    - `test_route_modules_importable`, `test_blueprint_instances`, `test_routes_init_exists`
    - _Requirements: 4.1, 4.2, 4.3, 4.4_

  - [x] 4.2 Write property test for empty blueprint registration
  ...
  - [x] 4.3 Write property test for route module Blueprint exports
...
- [x] 6. Create database seed script
...
- [x] 7. Scaffold React + Vite + Tailwind frontend
  ...
  - [x] 7.1 Write unit tests for frontend file existence
